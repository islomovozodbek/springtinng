...
export function AuthProvider({ children }) {
      ...
      try {
        ...
        if (data) {
          ...
          setUser({
            ...
            activeAccessories: data.active_accessories || [],
  ...
  const register = async ({ username, email, password }) => {
    ...
    setUser({
      ...
      unlockedThemes: profileData?.unlocked_themes || ["default"],
      unlockedAccessories: profileData?.unlocked_accessories || [],
      activeTheme: profileData?.active_theme || "default",
      activeAccessories: profileData?.active_accessories || [],
